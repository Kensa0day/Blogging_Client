...
//             <img src={post?.img} alt={post?.title} className='w-12 h-12 rounded-full object-cover'/>
//             <div className='w-full flex flex-col gap-1'>
//                 <span className={`${catColor} w-fit rounded-full px-2 py-0.5  text-white text-[12px] 2xl:text-sm`}>{post.cat}</span>
...
//             <p className='text-xl font-bold -mb-6 text-gray-600 dark:text-white '>Popular Posts</p>
