    ...
    <div className='flex w-full h-[100vh]'>
      ...
      <div className='w-full h-full flex flex-col items-center justify-center py-12 px-4 sm:px-0 lg:px-8'>
        ...
        <div className='w-full space-y-6 flex flex-col justify-start'>
          ...
          {showForm ? (
          <form className='max-w-md w-full mt-8 space-y-8' onSubmit={handleSubmit}>
            <div className='flex flex-col rounded-md shadow-sm space-y-px gap-6 mb-8'>
              ...
              <div className='flex items-center justify-between py-4'>
                <label htmlFor='imgUpload' className='flex items-center gap-1 text-base text-black dark:text-gray-500 cursor-pointer'>
                  <input id='imgUpload' type='file' onChange={(e) => setFile(e.target.files[0])}
                  className='hidden'
                  data-max-size='1024'
                  accept='.jpg, .png, .jpeg'
                  />
          ...
          <div className='max-w-md w-full space-y-8'>
            ...
            <p className='max-w-md w-full text-center mb-20 text-gray-600 dark:text-gray-300'>
